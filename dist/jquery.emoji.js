...
a("dialog",function(a){"use strict";var b=this,c=(b.$helpers,b.$each),d=a.tabs,e=(a.tab,a.index,b.$escape),f=a.smilies,g=(a.smily,a.basePath),h="";return h+=' <div class="cok-emoji-wrapper cok-hidden"> <ul class="tab-nav"> ',c(d,function(a){h+=' <li class="tab-item active"> <a href="javascript:;" hidefocus="true">',h+=e(a.title),h+="</a> </li> "}),h+=' <li class="tab-placeholder"></li> </ul> <div class="tab-content"> ',c(d,function(a){h+=' <div class="tab-pane active" data-tab="',h+=e(a.name),h+='"> <ul class="emojis"> ',c(f[a.name],function(a){h+=' <li data-emoji="',h+=e(a.emoji),h+='" class="emoji"> <img src="',h+=e(g),h+="/",h+=e(a.image),h+='" alt="',h+=e(a.title),h+='" title="',h+=e(a.title),h+='"> </li> '}),h+=" </ul> </div> "}),h+=" </div> </div> ",new k(h)})}();
(function(){
